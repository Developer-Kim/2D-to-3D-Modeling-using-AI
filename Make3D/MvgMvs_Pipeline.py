...
OPENMVG_BIN = "/home/kangwook/openMVG_Build/Linux-x86_64-RELEASE"
OPENMVS_BIN = "/home/kangwook/openMVS_build/bin"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/kangwook/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
    ...
    def __init__(self):
        self.steps_data=[
            ...
            [   "Compute features",
                ...
                ["-u", "1","-p", "NORMAL", "-i", "%matches_dir%/sfm_data.json", "-o", "%matches_dir%", "-m", "SIFT", "-n", "4"] ],
            [   "Compute matches",
                os.path.join(OPENMVG_BIN, "openMVG_main_ComputeMatches"),
                ["-r", ".8", "-i", "%matches_dir%/sfm_data.json", "-o", "%matches_dir%"] ],
